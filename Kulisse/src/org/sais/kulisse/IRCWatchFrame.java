...
public class IRCWatchFrame extends javax.swing.JFrame implements ServerSelectDialog.ServerSelectDialogCallback {
    ...
    private void connect(String server, int port) {
        ...
        agent = new IRCAgent(this, manager, _channel.getText());
        ...
        while (true) {
            try {
                agent.connect(agent.server, agent.port);
                break;
        ...
        agent.joinChannel(_channel.getText());
    ...
    void sendInputedMessage(boolean isNotice) {
        ...
        if (isNotice) {
            agent.sendNotice(_channel.getText(), message);
            showMessage("<" + agent.getNick() + "> " + message, Color.RED);
            _inputMessage.setText("");
            _inputMessage.requestFocus();
        } else {
            agent.sendMessage(_channel.getText(), message);
            showMessage("<" + agent.getNick() + "> " + message);
            _inputMessage.setText("");
            _inputMessage.requestFocus();
        }
    }
    ...
    private void initComponents() {
        ...
        _nick.setText("Kulisse_3.2");
        _nick.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                _nickActionPerformed(evt);
            }
        });
        ...
        _channel.setFont(new java.awt.Font("MS PGothic", 0, 12)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(_inputMessage, javax.swing.GroupLayout.DEFAULT_SIZE, 429, Short.MAX_VALUE)
...
// TODO add your handling code here:
      ...
      DccFileTransfer transfer = agent.dccSendFile(file, target, 120000);
  ...
  private void _settopicActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event__settopicActionPerformed
      ...
      agent.setTopic(_channel.getText(), _topic.getText());
      _topic.setText("");
      _inputMessage.requestFocus();
  ...
  private void _changenickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event__changenickActionPerformed
      agent.changeNick(_nick.getText());
...
private void _nickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event__nickActionPerformed
    // TODO add your handling code here:
}//GEN-LAST:event__nickActionPerformed
    /**
