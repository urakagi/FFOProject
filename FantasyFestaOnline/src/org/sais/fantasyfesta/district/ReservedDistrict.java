 ...
 * @author Romulus
 */
public class ReservedDistrict extends CardSetDistrict {

    @Override
    public ERegion getRegion() {
        return ERegion.RESERVED;
    }
    ...
    public void handleMoving(GameCore core, Card card, EMoveTarget to, EPlayer newController, boolean active, boolean simple, String extraMessage) {
        ...
        if (!simple) {
            if (to == EMoveTarget.ACTIVATED) {
                ...
                core.writeAndSendReplay(FTool.parseLocale(307, card.getName()));
            } else {
